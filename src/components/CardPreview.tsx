...
const LionEmblemSmall: React.FC = () => (
  <svg width="34" height="42" viewBox="0 0 100 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="gold-lion-sm" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <path
      d="M50 12 C42 12, 38 20, 38 28 C38 34, 42 38, 44 42 C40 44, 38 48, 40 54 C42 60, 48 62, 50 62 C52 62, 58 60, 60 54 C62 48, 60 44, 56 42 C58 38, 62 34, 62 28 C62 20, 58 12, 50 12 Z"
      fill="url(#gold-lion-sm)"
    />
    <rect x="20" y="64" width="60" height="12" rx="2" fill="url(#gold-lion-sm)" />
    <circle cx="50" cy="70" r="4" fill="#000080" />
    <path d="M26 76 C26 76, 32 90, 50 90 C68 90, 74 76, 74 76 Z" fill="url(#gold-lion-sm)" />
  </svg>
);
      ...
      <div className="w-full overflow-x-auto flex justify-center py-2">
        ...
        >
          ...
          <div className="relative w-full h-[88px] bg-gradient-to-r from-[#FF9933] via-[#FFAF54] to-[#FF8000] border-b-4 border-[#D4AF37] shadow-sm flex items-center justify-between px-6">
            ...
            {/* Subheader Badge with Tiranga photo.png (No Black Background) */}
          ...
          <div className="relative z-10 h-[342px] grid grid-cols-12 gap-4 items-center px-6 py-4">
            ...
            <div className="col-span-3 flex flex-col items-center">
              <div className="relative w-[136px] h-[168px] rounded-xl p-1.5 bg-gradient-to-b from-[#FF9933] via-[#D4AF37] to-[#138808] shadow-lg">
            ...
            {/* CENTER: User Details (5.5 cols) */}
            <div className="col-span-6 flex flex-col space-y-3.5 text-slate-900 pr-2">
              {/* Name Field */}
              <div className="flex items-baseline gap-2 border-b-2 border-dashed border-amber-300/80 pb-1.5">
                <span className="font-extrabold text-base text-[#7A3E00] shrink-0">नाम :</span>
                <span className="font-extrabold text-base text-[#1A202C] truncate tracking-wide">
              ...
              {/* ID No Field */}
              <div className="flex items-baseline gap-2 border-b-2 border-dashed border-amber-300/80 pb-1.5">
                <span className="font-extrabold text-base text-[#7A3E00] shrink-0">ID No. :</span>
                <span className="font-mono font-extrabold text-base text-amber-900 tracking-wider">
                  {cardData.idNo || "______________________"}
                </span>
              </div>

              {/* Address Field */}
              <div className="flex items-start gap-2 border-b-2 border-dashed border-amber-300/80 pb-1.5">
                <span className="font-extrabold text-base text-[#7A3E00] shrink-0">पता :</span>
                <span className="font-bold text-xs text-slate-800 line-clamp-3 leading-relaxed">
          ...
          {/* BOTTOM EMERALD GREEN FOOTER RIBBON WITH SATYAMEVA JAYATE (Bright Green, No Black) */}
          <div className="absolute bottom-0 left-0 right-0 h-[62px] bg-gradient-to-r from-[#0D5C06] via-[#138808] to-[#0A4A05] border-t-4 border-[#D4AF37] px-6 flex items-center justify-between text-white">
            <div className="flex items-center gap-3">
              {/* eslint-disable-next-html-element-suppress */}
              <img
                src="/satya1.png"
            ...
            {/* National Motto Pill - Warm Green Background */}
            <div className="flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#073D03] border border-amber-300/60 text-[11px] font-extrabold text-amber-200 shadow-sm">
              {/* eslint-disable-next-html-element-suppress */}
              <img
                src="/tiranga%20photo.png"
                alt="Tiranga"
                className="w-4 h-3 object-contain rounded-xs inline"
              />
              <span>जय हिंद • Vande Mataram</span>
            </div>

            {/* Bottom Right: Xpertbite Technology branding */}
